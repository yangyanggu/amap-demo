          ...
          if (conf) {
            map.add(
              new AMap.Marker({
                ...
                content:
                  `<div style="margin-bottom: 10px; float: left; font-size: 14px;height: 57px; width: 180px; color:#fff; background: no-repeat url(${conf}); background-size: 100%;"><p style="margin: 7px 0 0 35px; height: 20px; line-height:20px;">${props["名称"]}人口 ${props["人口"]}</p>` +
                  `<p style="margin: 4px 0 0 35px; height: 20px; line-height:20px; color: #00a9ff; font-size: 13px;">${props["GDP"]} 元` +
                  `</p></div>`
              })
            );
          }
